$subscriptionId = "b9b4d184-4d3d-48be-bc6d-ea7c80fdc35f"

$vmrg = "GAV-ARV-DEV-GEN-01" 

$diagnosticsStorageAccountRGName = "GAV-ARV-DEV-GEN-01"

$diagnosticsStorageAccountName = "arvdevstrdag001"

$logAnalyticsName = "gav-arv-dev-mon-la-001"

$logAnalyticsResourceGroupName = "GAV-ARV-DEV-MON-01" 
